...
export const eventQueryHelp = (
  <div className="gf-form--grow">
    <pre>
      ...
      additional time filters <Code>startTime</Code>, <Code>endTime</Code>,{' '}
      <Code>activeAtTime</Code>, <Code>createdTime</Code>, <Code>lastUpdatedTime</Code>.
      <br />
      Example how to get all active events that started in the current time range and finished at
      some point in time:
      <br />
